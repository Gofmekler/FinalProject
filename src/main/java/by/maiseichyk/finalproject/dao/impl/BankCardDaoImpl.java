...
public class BankCardDaoImpl extends BaseDao<BankCard> implements BankCardDao {
    ...
    private static final String FIND_ALL_OPERATIONS = "SELECT card_number, idcard_operations, operation_amount FROM card_operations";
    private static final String FIND_USER_OPERATIONS = "SELECT card_number, idcard_operations, operation_amount FROM card_operations WHERE login = ?";
    ...
    public boolean insert(BankCard bankCard) throws DaoException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(INSERT_BANKCARD)) {
            ...
            LOGGER.error("Can't insert new card to Database: " + e);
    ...
    public boolean delete(BankCard bankCard) throws DaoException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(DELETE_BANKCARD)) {
            ...
            LOGGER.error("Can't delete card in Database: " + e);
    ...
    public List<BankCard> findAll() throws DaoException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(FIND_ALL_BANKCARDS);
            ...
            LOGGER.error("Error has occurred while finding cards: " + e);
    ...
    public Optional<BankCard> findCardByCardNumber(long cardNumber) throws DaoException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(FIND_BANKCARD_BY_CARD_NUMBER)) {
            ...
            LOGGER.error("Error has occurred while finding card by number: " + e);
    ...
    public void updateCardBalance(long cardNumber, BigDecimal balance) throws DaoException {
        try (PreparedStatement statement = connection.prepareStatement(UPDATE_BALANCE)) {
            ...
            LOGGER.error("Can't update card balance in Database: " + e);
            throw new DaoException("Can't update card balance in Database: ", e);
        }
    }

    @Override
    public void updateOwnerName(long cardNumber, String ownerName) throws DaoException {
        try (PreparedStatement statement = connection.prepareStatement(UPDATE_OWNER_NAME)) {
            statement.setString(1, ownerName);
            statement.setString(2, String.valueOf(cardNumber));
            statement.executeUpdate();
        } catch (SQLException e) {
            LOGGER.error("Can't update card owner in Database: " + e);
            throw new DaoException("Can't update card owner in Database: ", e);
        }
    }

    @Override
    public boolean updateExpirationDate(long cardNumber, LocalDate date) throws DaoException {
        boolean status;
        try (PreparedStatement statement = connection.prepareStatement(UPDATE_EXPIRATION_DATE)) {
            statement.setString(1, date.toString());
            statement.setString(2, String.valueOf(cardNumber));
            statement.executeUpdate();
            status = true;
        } catch (SQLException e) {
            LOGGER.error("Can't update card date in Database: " + e);
            throw new DaoException("Can't update card date in Database: ", e);
        }
        return status;
    }
    ...
    public boolean insertOperation(long cardNumber, String login, BigDecimal amount) throws DaoException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(INSERT_OPERATION)) {
            ...
            LOGGER.error("Can't insert new operation: " + e);
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(FIND_USER_OPERATIONS)) {
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                while (resultSet.next()) {
                    operation.put(resultSet.getString(1) + resultSet.getString(2), resultSet.getBigDecimal(3));
                }
                operationList.add(operation);
            }
        } catch (SQLException e) {
            LOGGER.error("Error has occurred while finding user operations: " + e);
    ...
    public List<Map<String, BigDecimal>> findAllOperations() throws DaoException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(FIND_ALL_OPERATIONS);
            ...
            LOGGER.error("Error has occurred while operations: " + e);
